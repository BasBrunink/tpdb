...
export class MockParkService {
  parks: Park[] = [
    ...
    },
    {
      ...
      updated: DateTime.now(),
      name: 'Efteling',
      description: 'De Efteling is een attractiepark en recreatiecomplex in Kaatsheuvel, een dorp in de Nederlandse provincie Noord-Brabant. Naast het attractiepark omvat de hele Wereld van de Efteling een theater (Efteling Theater), drie hotels (Efteling Grand Hotel, Efteling Wonder Hotel en Efteling Loonsche Land Hotel) en twee vakantieparken (Efteling Bosrijk en Efteling Loonsche Land).\n' +
        '\n' +
