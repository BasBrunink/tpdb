...
export class AccomodationTypeController {
  constructor(private readonly accomodationTypeService: AccomodationTypeService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAccomodationTypeDto: UpdateAccomodationTypeDto) {
