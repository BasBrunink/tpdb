...
import com.tpdb.infrastructure.repository.adapter.common.LocationRepositoryAdapter;
...
public class RepoConfig {
    ...
    public ParkRepository parkRepository(
            JpaParkRepository parkRepo,
            ParkEntityMapper parkEntityMapper,
            ParkTypeEntityMapper parkTypeEntityMapper,
            LocationEntityMapper locationEntityMapper
    ) {
        return new ParkRepositoryAdapter(
                parkRepo,
                parkEntityMapper,
                parkTypeEntityMapper,
    ...
    public LocationRepository locationRepository(
        ...
        return new LocationRepositoryAdapter(
                locationRepository,
                locationEntityMapper);
    }
